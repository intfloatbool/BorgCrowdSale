...
contract WalletSplitter is PaymentSplitter, SignerRole, MultiSigWallet {
    constructor(address[] memory payees, uint256[] memory shares) PaymentSplitter(payees, shares) MultiSigWallet(payees, payees.length) public {
